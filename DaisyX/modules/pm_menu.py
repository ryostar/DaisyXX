...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(strings["btn_source"], url="https://t.me/Hisabo/"),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/nangcuc"),
        InlineKeyboardButton(strings["btn_group"], url="https://t.me/kenhsex"),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add me to your group",
            url=f"https://telegram.me/nangcuc_robot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/nangcuc_robot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
